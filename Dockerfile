...
ENTRYPOINT neo.sh open-db-tunnel -h $BTP_SUBACCOUNT_HOST -u $BTP_SUBACCOUNT_USER -p $BTP_SUBACCOUNT_PASSWORD -a
$BTP_SUBACCOUNT_ID -i $BTP_SUBACCOUNT_DB --background
